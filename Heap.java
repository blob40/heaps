public class Heap {
    ...
    // post condition: the largest element of the heap is removed and the heap is
    // re-heap
    ...
    // pre condition: index is the index of the item that was just moved to the root
    // of the heap
    // post condition: the heap is re-heapafied
